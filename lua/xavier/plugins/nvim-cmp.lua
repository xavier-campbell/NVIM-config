return {
	...
	dependencies = {
		...
		"hrsh7th/cmp-path", -- source for file system paths
		{
			...
			version = "v2.*", -- replace 2 (current major) by the latest released major (first number of latest release)
		},
	...
	config = function()
		...
		-- returns true if cursor is in the leftmost column or a whitespace character
	...
	cmp.setup({
		...
		-- configures nvim-cmp engine to work with snippets
		snippet = {
		...
		mapping = cmp.mapping.preset.insert({
			...
			-- accepts autocomplete suggestion, can use ctrl+y or enter key
